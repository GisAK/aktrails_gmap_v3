...
<head>
 ...
 var CS_env = {"relativeBaseUrl": "", "loggedInUserEmail": null, "domainName": null, "assetHostPath": "http://www.gstatic.com/codesite/ph", "profileUrl": null, "assetVersionPath": "http://www.gstatic.com/codesite/ph/3076573747170053082", "projectName": "geoxml3", "token": null, "projectHomeUrl": "/p/geoxml3"};
 var _gaq = _gaq || [];
 _gaq.push(
 ...
 <link type="text/css" rel="stylesheet" href="http://www.gstatic.com/codesite/ph/3076573747170053082/css/d_sb.css" >
...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgeoxml3%2Fsource%2Fbrowse%2Fbranches%2Fkmz%2Fgeoxml3.js&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fgeoxml3%2Fsource%2Fbrowse%2Fbranches%2Fkmz%2Fgeoxml3.js" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <li><a href="/p/geoxml3/source/browse/branches/kmz/geoxml3.js?r=100" title="Previous">&lsaquo;r100</a></li>
 
 </ul>
 </td>
 
 <td class="flipper"><b>r110</b></td>
...
<pre><table width="100%" id="nums_table_0"><tr id="gr_svn110_1"
...
><td class="source">        styleNodes = getElementsByTagName(thisNode, &#39;hotSpot&#39;);<br></td></tr
><tr
id=sl_svn110_278
...
><td class="source">        if ( (icon.dim.w &lt; 0 || icon.dim.h &lt; 0) &amp;&amp; (icon.xunits != &#39;pixels&#39; || icon.yunits == &#39;fraction&#39;) || icon.scale != 1.0) {<br></td></tr
><tr
id=sl_svn110_291
...
><td class="source">    if (!responseXML) {<br></td></tr
><tr
id=sl_svn110_410
...
><td class="source">                  if (doc.markers[j].getPosition().equals(placemark.latlng)) {<br></td></tr
><tr
id=sl_svn110_652
...
><td class="source">            if (marker) marker.active = placemark.visibility;<br></td></tr
><tr
id=sl_svn110_663
...
><td class="source">    if (!icon.href) return;<br></td></tr
><tr
id=sl_svn110_925
...
><td class="source">      y:  icon.dim.y     * icon.scale,<br></td></tr
><tr
id=sl_svn110_967
...
><td class="source">    var point = path[Math.floor(path.length/2)];<br></td></tr
><tr
id=sl_svn110_1116
...
><td class="source">  if (typeof ActiveXObject != &#39;undefined&#39; &amp;&amp; typeof GetObject != &#39;undefined&#39;) {<br></td></tr
><tr
id=sl_svn110_1418
...
><td class="source">  return createElement(&#39;div&#39;, null);<br></td></tr
><tr
id=sl_svn110_1428
...
><td class="source">        var xmlDoc = xhrFetcher.fetcher.responseXML;<br></td></tr
><tr
id=sl_svn110_1483

><td class="source">        if (xmlDoc &amp;&amp; !xmlDoc.documentElement &amp;&amp; !xmlDoc.ownerElement) xmlDoc.loadXML(xhrFetcher.fetcher.responseText);<br></td></tr
><tr
id=sl_svn110_1484

><td class="source">          callback(xmlDoc);          <br></td></tr
><tr
id=sl_svn110_1485
...
><td class="source">          callback(geoXML3.xmlParse(xhrFetcher.fetcher.responseText));<br></td></tr
><tr
id=sl_svn110_1487
...
<script type="text/javascript">
 ...
 gutterOut();
 var newTR = document.getElementById('gr_svn110_' + num);
 if (newTR) {
 ...
 <p>Change log</p>
 <div>
 <a href="/p/geoxml3/source/detail?spec=svn110&amp;r=110">r110</a>
 by geocodezip
 on Nov 10, 2013
 &nbsp; <a href="/p/geoxml3/source/diff?spec=svn110&r=110&amp;format=side&amp;path=/branches/kmz/geoxml3.js&amp;old_path=/branches/kmz/geoxml3.js&amp;old=100">Diff</a>
 </div>
 <pre>fix inconsistency between google.maps.Icon
and KML definition of anchor Y direction</pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/geoxml3/source/detail?r=110&spec=svn110';
 var publish_url = '/p/geoxml3/source/detail?r=110&spec=svn110#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/branches/kmz/geoxml3.js');
 changed_urls.push('/p/geoxml3/source/browse/branches/kmz/geoxml3.js?r\x3d110\x26spec\x3dsvn110');
 ...
 <option value="/p/geoxml3/source/browse/branches/kmz/geoxml3.js?r=110&amp;spec=svn110"
 selected="selected"
 ...
 Project members,
 <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgeoxml3%2Fsource%2Fbrowse%2Fbranches%2Fkmz%2Fgeoxml3.js&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fgeoxml3%2Fsource%2Fbrowse%2Fbranches%2Fkmz%2Fgeoxml3.js"
 ...
 <a href="/p/geoxml3/source/detail?spec=svn110&r=100">r100</a>
 by geocodezip
 on May 15, 2013
 &nbsp; <a href="/p/geoxml3/source/diff?spec=svn110&r=100&amp;format=side&amp;path=/branches/kmz/geoxml3.js&amp;old_path=/branches/kmz/geoxml3.js&amp;old=92">Diff</a>
 <br>
 <pre class="ifOpened">fix <a title="bounds not correct for multiple LineStrings in MultiGeometry" class=closed_ref href="/p/geoxml3/issues/detail?id=86"> issue #86 </a>, make polyline bounds
cover all segments of polyline</pre>
 </div>
 
 <div class="closed" style="margin-bottom:3px;" >
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="http://www.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="http://www.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/geoxml3/source/detail?spec=svn110&r=92">r92</a>
 by geocodezip
 on Feb 1, 2013
 &nbsp; <a href="/p/geoxml3/source/diff?spec=svn110&r=92&amp;format=side&amp;path=/branches/kmz/geoxml3.js&amp;old_path=/branches/kmz/geoxml3.js&amp;old=89">Diff</a>
 <br>
 <pre class="ifOpened">apply patch for <a title="'google.maps.Point' is null or not an object" class=closed_ref href="/p/geoxml3/issues/detail?id=79"> issue 79 </a></pre>
 </div>
 
 <div class="closed" style="margin-bottom:3px;" >
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="http://www.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="http://www.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/geoxml3/source/detail?spec=svn110&r=89">r89</a>
 by geocodezip
 on Dec 22, 2012
 &nbsp; <a href="/p/geoxml3/source/diff?spec=svn110&r=89&amp;format=side&amp;path=/branches/kmz/geoxml3.js&amp;old_path=/branches/kmz/geoxml3.js&amp;old=88">Diff</a>
 <br>
 <pre class="ifOpened">fix hotSpot handling</pre>
 </div>
 
 
 <a href="/p/geoxml3/source/list?path=/branches/kmz/geoxml3.js&start=110">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
...
<script src="http://www.gstatic.com/codesite/ph/3076573747170053082/js/prettify/prettify.js"></script>
<script type="text/javascript">prettyPrint();</script>


<script src="http://www.gstatic.com/codesite/ph/3076573747170053082/js/source_file_scripts.js"></script>
...
<script src="http://www.gstatic.com/codesite/ph/3076573747170053082/js/code_review_scripts.js"></script>
<script type="text/javascript">
 ...
 var paths = {'svn110': '/branches/kmz/geoxml3.js'}
 codereviews = CR_controller.setup(
 {"relativeBaseUrl": "", "loggedInUserEmail": null, "domainName": null, "assetHostPath": "http://www.gstatic.com/codesite/ph", "profileUrl": null, "assetVersionPath": "http://www.gstatic.com/codesite/ph/3076573747170053082", "projectName": "geoxml3", "token": null, "projectHomeUrl": "/p/geoxml3"}, '', 'svn110', paths,
